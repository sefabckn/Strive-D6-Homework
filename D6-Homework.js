...
me.programmingLanguage = skills
console.log(me)
/* EXERCISE G
   Write a piece of code for programmatically removing the last skill from the skills array inside the me object.
*/
delete me.programmingLanguage.pop()
console.log(me)
// JS Functions
/* EXERCISE 1
...
*/
const splitMe = function(stringName){
  return stringName.split(" ")
}
console.log(splitMe("My name is Sefa"))
/* EXERCISE 4
    Write a function called deleteOne which receives a string and a boolean as parameters.
    If the boolean value is true it should return the string without the first letter, otherwise it should remove the last one from it.
*/
const deleteOne = function(stringGiven,boolean){
  
  if(boolean === true){
    let newString = stringGiven.substring(1)
    return newString 
  }else{
    let newString = stringGiven.substring(0, stringGiven.length - 1);
    return newString
  }
}
console.log(deleteOne("Sefa",false))
/* EXERCISE 5
